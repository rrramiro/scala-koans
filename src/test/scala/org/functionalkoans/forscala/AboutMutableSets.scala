...
class AboutMutableSets extends FunSuite with Matchers with KoanMatcher  {
  ...
  test("Mutable sets can have elements removed") {
    val mySet = mutable.Set("Michigan", "Ohio", "Wisconsin", "Iowa")
    mySet -= "Ohio"
    mySet contains "Ohio" should be(__)
  }

  test("Mutable sets can have tuples of elements removed") {
    val mySet = mutable.Set("Michigan", "Ohio", "Wisconsin", "Iowa")
    mySet -= ("Iowa", "Ohio")
    mySet contains "Ohio" should be(__)
    mySet.size should be(__)
  ...
  test("Mutable sets can have tuples of elements added") {
  ...
  test("Mutable sets can have Lists of elements added") {
    val mySet = mutable.Set("Michigan", "Wisconsin")
  ...
  test("Mutable sets can have Lists of elements removed") {
    val mySet = mutable.Set("Michigan", "Ohio", "Wisconsin", "Iowa")
    mySet --= List("Iowa", "Ohio")
    mySet contains "Ohio" should be(__)
    mySet.size should be(__)
  ...
  test("Mutable sets can be cleared") {
    val mySet = mutable.Set("Michigan", "Ohio", "Wisconsin", "Iowa")
