...
class Koan09Classes extends FunSuite with Matchers with KoanMatcher {
  ...
  test("In Scala, the constructor is the body of the class") {
    class AClass {
  ...
  test("In Scala, a class can take constructor parameters") {
  ...
  test("Case classes are special classes with methods auto-generated by the compiler.") {
